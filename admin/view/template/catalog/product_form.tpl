            ...
            <table class="form">
              ...
              <tr>
               ...
               <tr>
                ...
                <td><textarea name="product_description[<?=$language['language_id']?>][short_description]" id="short_description<?=$language['language_id']?>"><?=isset($product_description[$language['language_id']])?$product_description[$language['language_id']]['short_description']:''?></textarea></td>
              </tr>
               <tr>
                <td>Характеристики товара:</td>
                <td><textarea name="product_description[<?=$language['language_id']?>][specifications]" id="specifications<?=$language['language_id']?>"><?=isset($product_description[$language['language_id']])?$product_description[$language['language_id']]['specifications']:''?></textarea></td>
              </tr>
               ...
               <tr>
                <td>Фото товара:</td>
                <td><textarea name="product_description[<?=$language['language_id']?>][photos]" id="photos<?=$language['language_id']?>"><?=isset($product_description[$language['language_id']])?$product_description[$language['language_id']]['photos']:''?></textarea></td>
              </tr>
              <tr>
                <td>Отзывы товара:</td>
                <td><textarea name="product_description[<?=$language['language_id']?>][reviews]" id="reviews<?=$language['language_id']?>"><?=isset($product_description[$language['language_id']])?$product_description[$language['language_id']]['reviews']:''?></textarea></td>
              </tr>
               <tr>
                <td>Услуги товара:</td>
                <td><textarea name="product_description[<?=$language['language_id']?>][services]" id="services<?=$language['language_id']?>"><?=isset($product_description[$language['language_id']])?$product_description[$language['language_id']]['services']:''?></textarea></td>
              </tr>
               <tr>
                <td>Места доставки:</td>
                <td><textarea name="product_description[<?=$language['language_id']?>][deliv_cities]" id="deliv_cities<?=$language['language_id']?>"><?=isset($product_description[$language['language_id']])?$product_description[$language['language_id']]['deliv_cities']:''?></textarea></td>
              </tr>
...
CKEDITOR.replace('specifications<?php echo $language['language_id']; ?>', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
CKEDITOR.replace('deliv_cities<?php echo $language['language_id']; ?>', {
  filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
CKEDITOR.replace('photos<?php echo $language['language_id']; ?>', {
  filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
CKEDITOR.replace('reviews<?php echo $language['language_id']; ?>', {
  filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
CKEDITOR.replace('services<?php echo $language['language_id']; ?>', {
  filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
// , specifications, , reviews, services
<?php } ?>
//--></script> 
<script type="text/javascript"><!--
