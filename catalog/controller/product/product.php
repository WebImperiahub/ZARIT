...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['deliv_cities'] = html_entity_decode($product_info['deliv_cities'], ENT_QUOTES, 'UTF-8');
			$this->data['specifications'] = html_entity_decode($product_info['specifications'], ENT_QUOTES, 'UTF-8');
			$this->data['photos'] = html_entity_decode($product_info['photos'], ENT_QUOTES, 'UTF-8');
			$this->data['reviews'] = html_entity_decode($product_info['reviews'], ENT_QUOTES, 'UTF-8');
			$this->data['services'] = html_entity_decode($product_info['services'], ENT_QUOTES, 'UTF-8');
